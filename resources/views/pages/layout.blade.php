...
<head>
    ...
    <script src="js/frontIe9.js"></script>
    <![endif]-->
...
<div id="footer">
    <div class="footer-instagram-section">
        ...
        <div id="footer-instagram" class="owl-carousel">
            ...
            <div class="item">
                <a href="#"><img src="pages/images/ins-1.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="apages/images/ins-2.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="pages/images/ins-3.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="pages/images/ins-4.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="pages/images/ins-5.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="pages/images/ins-6.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="pages/images/ins-7.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="pages/images/ins-8.jpg" alt=""></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="pages/images/footer-logo.png" alt=""></div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="single-review">
                                    ...
                                    <div class="author-id">
                                        <img src="pages/images/author.png" alt="">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        <div>
                            <a href="#"><img src="pages/images/footer-img.png" alt=""></a>
                        </div>
                        <div>
